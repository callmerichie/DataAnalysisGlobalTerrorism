...
library(treemap) #for treempas graphics
...
pie_chart <- plot_ly(iraqwar, labels = ~war, values = ~nkill, type = 'pie')
pie_chart <- pie_chart %>% layout(title = 'Comparing the two wars',
